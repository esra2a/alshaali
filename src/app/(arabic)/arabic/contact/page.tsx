          ...
          <div className="lg:col-span-5">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className={`text-lg font-semibold ${headingColor} mb-1`}>رقم الهاتف</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">الاتنين - الجمعه: 8:00 صباحًا - 6:00 مساءً</p>
                  <p className="text-gray-700">السبت - الأحد: مغلق</p>
                </div>
              </div>
            </div>
          </div>
