...
export const metadata = {
  ...
  keywords: ["محمد السيد المحامي","محاماة", "قانون", "مكتب محاماة", "مكتب الشعالي", "محامي في الإمارات", "Ahmed Alshaali Law Firm ", " Law Firm ", " Mohamed Alsayed lawyer "],
};
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight">
             مكتب أحمـد الشعـالي<br></br> حيث يلتقي القانون بالتميز
          </h1>
