...
const services = [
  ...
  },
  {
  ...
  },
   {
    ...
    description: "نقدم تمثيلًا قانونيًا متخصصًا في جميع القضايا الجنائية، مع التركيز على الدفاع عن الأفراد والمؤسسات المتهمين في جرائم بمختلف درجاتها. تشمل خدماتنا الترافع أمام الجهات القضائية، وحماية حقوق الموكلين أثناء التحقيق والمحاكمة، مع الالتزام التام بأحكام قانون العقوبات والإجراءات الجنائية في دولة الإمارات العربية المتحدة.",
    image: "/assets/legal_service_personal.webp",
    icon: CheckCircle,
    details: [
      " الجرائم الجنائية الكبرى (القتل، الاعتداء، المخدرات)",
      "قضايا الشيكات بدون رصيد والجرائم التجارية",
      "النفقة والتسويات المالية",
      "استئناف الأحكام والطعون الجنائية  ",
     
    ]
  },
  {
    id: "تطبيق",
    title: " قانون الأحوال الشخصية (قانون الأسرة)",
    description: "  نقدم تمثيلًا قانونيًا شاملًا في جميع قضايا الأحوال الشخصية، مع مراعاة الجوانب الإنسانية والقانونية لضمان حماية حقوق أفراد الأسرة. تشمل خبرتنا تقديم الاستشارات والترافع في مختلف قضايا الزواج والطلاق والحضانة والنفقة والمواريث، وفقًا لقوانين الأحوال الشخصية المعمول بها في دولة الإمارات العربية المتحدة.     ",
    image: "/assets/legal_service_implementation.webp", // Assuming this image exists
    icon: CheckCircle,
    details: [
      "إجراءات الزواج والطلاق   ",
