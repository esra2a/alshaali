  ...
  return (
    <>
      ...
      <section className="py-16 md:py-24 bg-white">
        ...
        أحمد الشعالي ببمحاماه، نؤمن بأن العدالة تبدأ بالخطوة الصحيحة. نوظف خبرتنا القانونية الواسعة وفهمنا العميق لقوانين دولة الإمارات العربية المتحدة لخدمة عملائنا بالتزامٍ راسخ واحترافية. نقدم حلولاً شاملة في مختلف المجالات، من التقاضي المدني والتجاري إلى الاستشارات المتخصصة.
            </p>
