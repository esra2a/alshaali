...
export const metadata = {
  ...
  keywords: [,"محمد السيد المحامي","محاماة", "قانون", "مكتب محاماة", "مكتب الشعالي", "محامي في الإمارات", "Ahmed Alshaali Law Firm ", " Law Firm ", " Mohamed alshenawi lawyer "],
};
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight">
            Ahmed Alshaali Firm<br></br> Where Law Meets Excellence
          </h1>
