...
const services = [
  ...
  },
  {
    id: "Maritime Law",
    title: " Maritime Law ",
    description: "We offer comprehensive legal support in maritime disputes and transactions, representing clients across shipping, trade, and marine insurance sectors with deep industry insight.",
    image: "/assets/legal_service_personal.webp", // Assuming this image exists
    icon: CheckCircle,
    details: [
      " Shipping & Charter Party Disputes",
      "Cargo Claims & Marine Insurance",
      "Vessel Arrest & Release Procedures",
      "Maritime Regulatory Compliance",
      "Collision & Salvage Cases",
    ]
  },
  {
    id: "Criminal Law",
    title: "Criminal Law",
    description: "Our team provides strategic representation in all stages of criminal proceedings, from investigation to trial. We work diligently to protect our clients' rights and ensure fair treatment under the law.",
    image: "/assets/legal_service_implementation.webp", // Assuming this image exists
    icon: CheckCircle,
    details: [
      "White-Collar Crime & Fraud Cases",
      "Cybercrime & Financial Offenses",
      "Extradition & Interpol Notices",
      "Regulatory Investigations",
      "Defense Before Criminal Courts",
    ]
  },
