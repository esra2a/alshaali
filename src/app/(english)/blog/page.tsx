          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
            {blogPosts.map((post, index) => (
              <div key={index} className={`${cardBgColor} rounded-lg shadow-md overflow-hidden border border-gray-100 flex flex-col transition duration-300 hover:shadow-xl group`}>
                <Link href={`/blog/`} className="block aspect-video relative overflow-hidden">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <Link href={`/blog/`} className={`${accentColor} font-medium text-sm mt-auto inline-flex items-center`}>
