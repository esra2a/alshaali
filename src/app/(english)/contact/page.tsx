    ...
    <>
      ...
      <section className="py-16 md:py-20 text-center bg-gradient-to-b from-gray-100 to-gray-50 border-b border-gray-200">
        <div className="container mx-auto px-6">
          <h1 className={`text-4xl md:text-5xl font-bold ${headingColor} mb-3`}>Contact Us</h1>
          <p className={`text-lg ${secondaryTextColor} max-w-2xl mx-auto`}>We are here to help. Reach out to us for a free consultation or any legal inquiries.</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16">
          ...
          <div className="lg:col-span-5">
            <h2 className={`text-3xl font-semibold ${headingColor} mb-6`}>Get In Touch</h2>
            <p className={`${secondaryTextColor} mb-8 text-base leading-relaxed`}>
              Our team is ready to assist you. Contact us via phone, email, or visit our office during working hours.
            </p>
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="#" className={`text-gray-700 hover:${accentColor} transition duration-300`}> +971501437584/+971567778217</a>
                </div>
              </div>
              <div className="flex items-start">
                             ...
                             <div>
                               ...
                               <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3608.576441219884!2d55.33717797538354!3d25.251187277676262!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjXCsDE1JzA0LjMiTiA1NcKwMjAnMjMuMSJF!5e0!3m2!1sen!2sae!4v1750880846830!5m2!1sen!2sae" ></iframe>
                             </div>
                           </div>
              <div className="flex items-start">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className={`text-lg font-semibold ${headingColor} mb-1`}>Working Hours</h3>
          ...
          <div className="lg:col-span-7 bg-gray-50 p-8 rounded-lg border border-gray-200">
            <h2 className={`text-3xl font-semibold ${headingColor} mb-6`}>Send Us a Message</h2>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label htmlFor="subject" className="block text-sm font-medium text-gray-700 mb-1">Message Title / Subject</label>
                <input
                  type="text"
                  id="subject"
                  name="subject"
